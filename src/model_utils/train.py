...
# Global parameters for model configuration
...
def train_val_on_single(train_items, model, optimizer, loss_fn, database_name, task_name, layer_type):
    ...
    for epoch in range(config.EPOCHS):
        ...
        if (higher_is_better and val_metrics[tune_metric] > best_val_metric) or (
            ...
            state_dict = copy.deepcopy(model.state_dict())  # Save best model state
...
def main():
    """
    Main function to initialize and run the training and validation process.
    """
